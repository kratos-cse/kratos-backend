...
# TODO(receipts-owner): the Receipt model's pdf_url is NOT NULL (app/models/receipt.py),
# so this can't insert a row until a PDF exists. Left as a call-out rather than a write.
