...
events.fee is a rupee amount (Numeric(10,2) in the finalized schema) — not
paise. Decimal in, so no floating-point rounding sneaks into money math
before the final int() conversion.
"""
