...
- **Retry with Exponential Backoff**: Wraps Razorpay API network calls (`app/services/razorpay_client.py`).
...
| `POST` | `/admin/payments/{payment_id}/refund` | Super Admin Header (`X-Debug-Is-Admin: true`) | Initiate refund via Razorpay |
