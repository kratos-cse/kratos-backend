...
def upgrade() -> None:
    ...
    notification_kind = postgresql.ENUM(*_NOTIFICATION_KIND, name="notification_kind")
    notification_status = postgresql.ENUM(*_NOTIFICATION_STATUS, name="notification_status")
    attendance_scan_result = postgresql.ENUM(*_ATTENDANCE_SCAN_RESULT, name="attendance_scan_result")
    duplicate_scan_behavior = postgresql.ENUM(*_DUPLICATE_SCAN_BEHAVIOR, name="duplicate_scan_behavior")
